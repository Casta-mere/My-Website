...
:::important 重要
该组件用到了 tailwindcss，没有配置的请参考 [Docusaurus Themes-Tailwindcss](/docs/Server/Docusaurus-Theme#tailwindcss)
:::
...
上面介绍了如何添加到 blog 页面，接下来是 doc 页面，略微有所不同。将下面的代码先贴到 `src/components/PageViewCounter/UmamiDocViewCounter.tsx`

<details>
<summary>UmamiDocViewCounter</summary>

```typescript title="src/components/PageViewCounter/UmamiDocViewCounter.tsx"
